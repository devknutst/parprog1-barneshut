...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries = {
    val nextBound = new Boundaries()
    nextBound.minX = a.minX min b.minX
    nextBound.minY = a.minY min b.minY
    nextBound.maxX = a.maxX max b.maxX
    nextBound.maxY = a.maxY max b.maxY
    nextBound
  }
